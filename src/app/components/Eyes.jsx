...
const Eyes = () => {
   ...
   const [rotate,setRotate] =useState(0);
    ...
    return (
    <div  data-scroll data-scroll-section data-scroll-speed='.3' className='w-full relative'>
      
      <img  className='object-cover w-full ' src="https://ochi.design/wp-content/uploads/2022/05/Top-Viewbbcbv-1-1440x921.jpg" alt="" />
        ...
        <div className='bg-white h-[200px]  w-[200px] absolute top-[300px] left-[35%] rounded-[50%]  '>
            <div className='bg-black h-[100px] w-[100px] rounded-[50%] absolute top-[50px] left-[50px]'>
                ...
                <div className='h-[20px] w-[20px] rounded-[50%] bg-white'>
